  ...
  template: `
    <section class="skills">
      ...
      <div class="skill-category">
        <h3 class="primary-accent languages">Languages</h3>
      ...
      <div class="skill-category">
        <h3 class="primary-accent development">Development</h3>
        <div class="skill-tags">
      ...
      <div class="skill-category">
        <h3 class="primary-accent data-science">Data Science & ML</h3>
        <div class="skill-tags">
